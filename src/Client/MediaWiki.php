...
namespace WikiConnect\MediawikiApi\Client;
...
use WikiConnect\MediawikiApi\Client\Discovery\ReallySimpleDiscovery;
use WikiConnect\MediawikiApi\Client\Rest\RestApi;
