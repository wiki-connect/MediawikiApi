...
namespace WikiConnect\MediawikiApi\Client\Discovery;

use WikiConnect\MediawikiApi\Client\RsdException;
use DOMDocument;
use DOMXPath;
...
class ReallySimpleDiscovery {
	...
	public static function baseFromPage( string $pageUrl ): string {
		...
		$tempClient = new Client( [ 'headers' => [ 'User-Agent' => 'wikiconnect-mediawiki-client' ] ] );
