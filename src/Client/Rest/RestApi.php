...
namespace WikiConnect\MediawikiApi\Client\Rest;
...
use WikiConnect\MediawikiApi\Client\Rest\Request\HasJsonBody;
...
class RestApi implements Requester, LoggerAwareInterface {
	...
	private function getUserAgent(): string {
		if ( !$this->auth instanceof NoAuth ) {
			...
			return 'wikiconnect-mediawiki-api/SomeUnknownUser?';
		}
