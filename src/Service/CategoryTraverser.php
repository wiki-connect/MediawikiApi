...
use WikiConnect\MediawikiApi\CategoryLoopException;
...
class CategoryTraverser extends Service {
	 ...
	 * @param callable $callback A callable that takes two \WikiConnect\MediawikiApi\DataModel\Page parameters.
	 */
